...
const translations = {
  en: {
    ...
    plan_accidents_f1: 'Battery charge (×6)',
    plan_accidents_f2: 'Fuel supply (×6)',
    plan_accidents_f3: 'Tire change (×6)',
    plan_accidents_f4: 'Light electrical & mechanical repair (×2)',
    plan_accidents_f5: 'Car towing in breakdowns (×2)',
    plan_accidents_f6: 'Accident vehicle transfer to assessment centre',
    plan_accidents_f7: 'Workshop of client\'s choice — included',
    plan_rental_f1: 'Battery charge (×6)',
    plan_rental_f2: 'Fuel supply (×6)',
    plan_rental_f3: 'Tire change (×6)',
    plan_rental_f4: 'Light electrical & mechanical repair (×2)',
    plan_rental_f5: 'Car towing in breakdowns (×2)',
    plan_rental_f6: 'Computer fault diagnostics (×3)',
    ...
    sub_sub: 'Fill in your details and our team will confirm your plan within 24 hours.',
    sub_plan_label: 'Selected Plan',
    sub_change_plan: 'Change plan',
    sub_per_year: 'SAR / year',
    sub_step1_title: 'Your Information',
    sub_name: 'Full Name',
    sub_name_ph: 'Mohammed Al-Rashidi',
    sub_phone: 'Phone Number',
    sub_phone_ph: '05XXXXXXXX',
    sub_email: 'Email Address',
    sub_email_ph: 'you@example.com',
    sub_step2_title: 'Your Vehicle',
    sub_make: 'Car Make',
    sub_make_ph: 'Toyota',
    sub_model: 'Model',
    sub_model_ph: 'Camry',
    sub_year: 'Year',
    sub_year_ph: '2022',
    sub_plate: 'Plate Number',
    sub_plate_ph: 'ABC 1234',
    sub_note: 'Additional Notes',
    sub_note_ph: 'Anything else we should know... (optional)',
    sub_terms: 'I agree to the Terms & Conditions. I understand this membership covers one vehicle for 12 months from activation.',
    sub_submit: 'Submit Application',
    sub_success_h2: 'Application received!',
    sub_success_body: "We'll review your details and confirm your membership within 24 hours via phone or WhatsApp.",
    sub_success_cta: 'Back to Home',
    sub_required: 'This field is required',
    sub_summary_title: 'Order Summary',
    sub_vat: 'VAT included',
  ...
  ar: {
    ...
    plan_accidents_f1: 'شحن البطارية (×6)',
    plan_accidents_f2: 'تزويد الوقود (×6)',
    plan_accidents_f3: 'تغيير الإطارات (×6)',
    plan_accidents_f4: 'صيانة كهربائية وميكانيكية خفيفة (×2)',
    plan_accidents_f5: 'سحب السيارة في حالة العطل (×2)',
    plan_accidents_f6: 'نقل سيارة الحادث إلى مركز تقدير الحوادث',
    plan_accidents_f7: 'ورشة من اختيار العميل — مشمولة',
    plan_rental_f1: 'شحن البطارية (×6)',
    plan_rental_f2: 'تزويد الوقود (×6)',
    plan_rental_f3: 'تغيير الإطارات (×6)',
    plan_rental_f4: 'صيانة كهربائية وميكانيكية خفيفة (×2)',
    plan_rental_f5: 'سحب السيارة في حالة العطل (×2)',
    plan_rental_f6: 'كشف الأعطال بالكمبيوتر (×3)',
    ...
    sub_h2: 'ابدأ عضويتك.',
    sub_sub: 'أدخل بياناتك وسيقوم فريقنا بتأكيد باقتك خلال 24 ساعة.',
    sub_plan_label: 'الباقة المختارة',
    sub_change_plan: 'تغيير الباقة',
    sub_per_year: 'ريال / سنة',
    sub_step1_title: 'معلوماتك الشخصية',
    sub_name: 'الاسم الكامل',
    sub_name_ph: 'محمد الراشدي',
    sub_phone: 'رقم الجوال',
    sub_phone_ph: '05XXXXXXXX',
    sub_email: 'البريد الإلكتروني',
    sub_email_ph: 'you@example.com',
    sub_step2_title: 'بيانات مركبتك',
    sub_make: 'الشركة المصنعة',
    sub_make_ph: 'تويوتا',
    sub_model: 'الموديل',
    sub_model_ph: 'كامري',
    sub_year: 'سنة الصنع',
    sub_year_ph: '2022',
    sub_plate: 'رقم اللوحة',
    sub_plate_ph: 'ABC 1234',
    sub_note: 'ملاحظات إضافية',
    sub_note_ph: 'هل هناك أي شيء آخر نحتاج معرفته؟ (اختياري)',
    sub_terms: 'أوافق على الشروط والأحكام. أؤكد أن هذه العضوية تغطي مركبة واحدة لمدة 12 شهراً من تاريخ التفعيل.',
    sub_submit: 'تقديم الطلب',
    sub_success_h2: 'تم استلام طلبك!',
    sub_success_body: 'سنراجع بياناتك ونؤكد عضويتك خلال 24 ساعة عبر الهاتف أو واتساب.',
    sub_success_cta: 'العودة إلى الرئيسية',
    sub_required: 'هذا الحقل مطلوب',
    sub_summary_title: 'ملخص الطلب',
    sub_vat: 'شامل ضريبة القيمة المضافة',
