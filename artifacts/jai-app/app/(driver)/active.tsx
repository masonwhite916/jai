...
const styles = StyleSheet.create({
  ...
  stepDot: { width: 12, height: 12, borderRadius: 6, backgroundColor: 'rgba(255,255,255,0.15)' },
  stepLine: { position: 'absolute', left: '50%', top: 5, right: '-50%', height: 2, backgroundColor: 'rgba(255,255,255,0.1)' },
