...
export const translations = {
  en: {
    ...
    deleteAccountMessage: 'This will permanently delete your account and personal data (vehicles, sessions, notifications). Service history is retained for 5 years as required by law. This cannot be undone.',
    deleteAccountConfirm: 'Delete',
    deleting: 'Deleting…',
    cancel: 'Cancel',
    switchRole: 'Switch to Technician',
  ...
  ar: {
    ...
    deleteAccountMessage: 'سيؤدي هذا إلى حذف حسابك وبياناتك الشخصية نهائيًا (المركبات، الجلسات، الإشعارات). يُحتفظ بسجل الخدمات لمدة 5 سنوات وفقًا للأنظمة المعمول بها. لا يمكن التراجع عن هذا الإجراء.',
    deleteAccountConfirm: 'حذف',
    deleting: 'جارٍ الحذف…',
    cancel: 'إلغاء',
    switchRole: 'التبديل إلى فني',
