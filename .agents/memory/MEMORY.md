...
- [EAS phantom deps](eas-pnpm-phantom-deps.md) — EAS re-installs without frozen lockfile after prebuild; undeclared modules (babel-preset-expo) break the release bundle; fetch real logs via build:list JSON
